...
- **Bug reports and feature requests:** Open an [issue](https://github.com/Whats-A-MattR/speedarr/issues).
- **Code changes:** Open a pull request against `main` (or `master`). Keep PRs focused and reference any related issues.

## Development setup

- **App:** See [Development](https://github.com/Whats-A-MattR/speedarr/blob/main/docs-site/src/content/docs/development.mdx) in the docs. In short: `cd app`, `npm install`, `npm run dev` (and optionally `npm run dev:node` for a second instance).
